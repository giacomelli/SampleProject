...
using ProjectSample.Infrastructure.Repositories.Memory;
...
namespace ProjectSample.Domain.UnitTests.Accounts
{
    ...
    public class UserServiceTest
    {
        ...
        {
            var actual = m_target.CanSendEmailNotificationTo("test@projectsampletest.com.br");
        ...
        {
            var user = new User() { Email = "test@projectsampletest.com.br", Enabled = false, Role = new Role() { EmailNotificationEnabled = true } };
        ...
        {
            var user = new User() { Email = "test@projectsampletest.com.br", Enabled = true, Role = new Role() { EmailNotificationEnabled = false } };
            m_userRepository.Add(user);
            m_unitOfWork.Commit();
        ...
        {
            var user = new User() { Email = "test@projectsampletest.com.br", Enabled = true, Role = new Role() { EmailNotificationEnabled = true } };
            m_userRepository.Add(user);
            m_unitOfWork.Commit();
